...
```
  ...
  git clone https://github.com/Yacoubou-seidou/hello-rails-react.git
```
...
Feel free to check the [issues page](https://github.com/Yacoubou-seidou/hello-rails-react/issues).
